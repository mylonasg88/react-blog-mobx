...
export default class CreatePost extends React.Component<TypeStateProps, *> {
    ...
    _trackContent(e: any) {
        this.props.blogStore.modelPost.content = e.target.value;
    }
    ...
    render() {
        return (
            <div className="form">
                ...
                {this.state.success ? (
                    <SuccessPopup onClick={this.setRedirect} />
                ) : null}
                ...
                <div className="form-element">
                    ...
                    <input
                        type="text"
                        name="title"
                        onChange={this._trackTitle.bind(this)}
                    />
                </div>
                <div className="form-element">
                    <label>Body: </label>
                    <textarea onChange={this._trackContent.bind(this)} />
                </div>
                <div className="form-element">
                    <button onClick={this.savePost.bind(this)}>
                        Create Post
                    </button>
                </div>
            </div>
